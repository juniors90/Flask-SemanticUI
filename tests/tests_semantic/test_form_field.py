...
def test_form_field_with_kwargs(app, client, hello_form):
    ...
    assert '<input class="ui submit button default" id="submit" name="submit" type="submit" value="test"' in data
    assert '<input class="ui submit button" id="submit" name="submit" type="submit" value="test"' not in data